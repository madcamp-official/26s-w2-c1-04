...
- 플러터를 처음 사용해보는데 생각보다 웹보다 신경쓸 것이 많았던 것 같습니다.
- 종화가 도맡아서 많은 부분을 작업 해주었습니다. 많이 배웠고 작업하면서 재미있었어요😇

**안종화:**

- 서버는 에러가 없어도 앱 빌드에는 수많은 에러가 생길 수 있음을 알게 되었습니다.
- 앱 개발은 신경쓸 것이 정말 많다고 느꼈습니다.
